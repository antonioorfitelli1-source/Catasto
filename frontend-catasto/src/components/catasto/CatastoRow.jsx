      ...
      <>
        ...
        >
          ...
          <td className="px-3 py-3 md:px-6 md:py-4">
            <div className="flex flex-col gap-1 text-xs md:text-sm">
              ...
              <div className="text-gray-700 ml-2 border-l-2 border-gray-300 pl-2">
                {row.quartiere}
              </div>
          ...
          <td className="hidden md:table-cell px-6 py-4">
            <div className="flex flex-col gap-1 text-sm text-skin-header-border font-mono bg-skin-display p-2 rounded w-fit border border-skin-border-light">
              <div className="flex items-center gap-2">
                <Bookmark className="h-3 w-3 text-skin-header" />
                <span className="font-bold">Vol.</span> {row.volume || "?"}
              </div>
              <div className="flex items-center gap-2">
                <FileText className="h-3 w-3 text-skin-header" />
          ...
          <td className="px-2 py-3 md:px-6 md:py-4 text-right">
            {expanded ? (
              <ChevronDown className="h-5 w-5 text-skin-header" />
            ) : (
        ...
        {expanded && (
          <tr className="bg-skin-sidebar">
            <td
              colSpan="5"
              className="px-4 py-4 md:px-6 md:py-6 border-b-2 border-skin-text-accent"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div>
                  <h3 className="text-xs md:text-sm font-bold text-skin-header-border uppercase tracking-wider mb-2 md:mb-3 flex items-center gap-2 border-b border-skin-text-accent pb-1">
                  ...
                  <div className="bg-skin-table-row p-3 md:p-4 rounded border border-skin-border shadow-sm space-y-3 md:space-y-4 text-xs md:text-sm">
                    <div className="grid grid-cols-2 gap-3 md:gap-4">
                      <div>
                        <span className="text-gray-500 uppercase block">
                          Credito
                        </span>
                        <span className="font-bold text-skin-text">
                          {row.credito || 0} fiorini
                        </span>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <span className="font-bold text-skin-header text-base md:text-lg">
                    ...
                    <div className="pt-2 border-t border-dashed border-gray-300 space-y-2">
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          {row.rapporto_mestiere || "Nessun dato"}
                        </div>
                      </div>
                    </div>
                    <div className="pt-2 border-t border-dashed border-gray-300">
                      <span className="text-[10px] md:text-xs text-gray-500 uppercase block mb-1">
                        Particolarità Fuoco
                      </span>
                ...
                <div>
                  ...
                  {loadingParenti ? (
                    ...
                    <div className="overflow-hidden border border-skin-border rounded-md bg-skin-table-row">
                      <table className="min-w-full divide-y divide-skin-border">
                        <thead className="bg-skin-table-header">
                          <tr>
                            <th className="px-2 py-2 text-left text-[10px] md:text-xs font-medium text-skin-header-border uppercase">
                              Parente
                            </th>
                            <th className="px-2 py-2 text-left text-[10px] md:text-xs font-medium text-skin-header-border uppercase">
                              Età
                    ...
                    <div className="text-xs md:text-sm text-gray-500 italic p-3 border border-dashed border-gray-300 rounded bg-gray-50">
