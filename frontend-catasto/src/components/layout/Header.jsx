    ...
    <header className="bg-skin-header text-skin-text-inverted shadow-md border-b-4 border-skin-header-border shrink-0 z-20 h-16 md:h-20 transition-all">
      <div className="w-full px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
        <div className="flex items-center gap-2 md:gap-3">
          ...
          >
            {isSidebarOpen ? (
              <X className="h-5 w-5 md:h-6 md:w-6 text-skin-text-accent" />
            ) : (
              <Menu className="h-5 w-5 md:h-6 md:w-6 text-skin-text-accent" />
            )}
          </button>
          ...
          <div>
            ...
            <p className="text-[10px] md:text-xs text-skin-text-accent uppercase tracking-wider hidden sm:block">
